...
<section class="about">
   ...
   <div class="row">
      ...
      <div class="image ">
         <img src="images/dp.jpg" alt="" class="mypic">
      </div>

      <div class="content">
         <h3>Developer's Message:</h3>
         <p>Hey There ! I'm Amit Kumar. A Student of B.Tech in Computer Science Engineering Department from IFTM UNIVERSITY [Moradabad] . 
            I love develop websites and exploring new things. Learning new things is my hobby.</p>

         <p>I would like to thank <a href="#" target="_blank">Dr.Devendra Singh </a>[HOD], <a href="#">Mr.Harpreet Chawla</a> and <a href="#">Dr.Abhisek </a>
         Sir for guiding me through the session and making me able to develop projects like this. </p>
...
<section class="reviews">
   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         ...
         <h3> <a href="# target="_blank">Anshika</a></h3>
      </div>

      <div class="swiper-slide slide">
         <img src="images/pic-1.jpg" alt="">
         <p>It is the first online services in india which we can trust completely.
            I always unbox making a video and instantly complain if there's
             anything wrong. Sometimes even don't need to return the item and they
              process the refund.E-Commerce.com do heavy fine to sellers who send wrong 
              products thats why its platform getting better day by day.</p>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
         ...
         <h3><a href="#" target="_blank">Mohd Mujtaba Ali</a></h3>
      </div>

      <div class="swiper-slide slide">
         <img src="images/pic-3.jpg" alt="">
         <p>E-Commerce.com is great if you choose good sellers . 
            A variety of required item available .
             Customers can return and refund full amount within 7 days easily .
             E-Commerce.com is boosting eCommerce business in U.P.
             It provides great opportunity to sale items online with ease.</p>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
         ...
         <h3><a href="#" target="_blank">Pankaj Jain</a></h3>
      </div>
